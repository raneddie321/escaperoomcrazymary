...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "קרייזי מרי" },
      { property: "og:title", content: "קרייזי מרי — מתחם הפחד של ירושלים" },
      { property: "og:description", content: "ארבע אטרקציות פחד לבחירתכם: חדר בריחה, מבוך אימה, מחבואים בחושך וזומבישוט — משחק יריות חדש." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "קרייזי מרי — מתחם הפחד של ירושלים" },
      { name: "twitter:description", content: "ארבע אטרקציות פחד לבחירתכם: חדר בריחה, מבוך אימה, מחבואים בחושך וזומבישוט." },
    ],
    links: [
