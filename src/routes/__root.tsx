...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Crazy Mary הוא מתחם הפחד של ישראל בירושלים: מבוך הפחד הגדול ביותר בישראל עם 2 קומות, הקבר, מחבואים בחושך ו-Zombie Shot — חוויה מפחידה, קולנועית ומרגשת." },
      { name: "author", content: "Crazy Mary Jerusalem" },
